 ...
 * Using the provided BaseAdapterHelper, your code is minimalist.<br/>
 * EnhancedQuickAdapter 主要为convert方法，添加一个itemChanged参数，
 * 用于区分 dataset changed / dataset invalidated
