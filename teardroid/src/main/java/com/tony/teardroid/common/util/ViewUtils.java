...
public class ViewUtils {
    ...
    /**
     * set ListView height which is calculated by {@link ViewUtils#getListViewHeightBasedOnChildren(ListView)}
     * 
     * @param view
     */
    ...
    /**
     * set AbsListView height which is calculated by {@link ViewUtils#getAbsListViewHeightBasedOnChildren(AbsListView)}
     * 
     * @param view
     */
